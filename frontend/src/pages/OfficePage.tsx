...
const OFFICE_OBJECTS: OfficeObject[] = [
  { id: 'desk', name: 'Рабочий стол', actionCode: 'WORK_ON_PROJECT', x: 50, y: 60, icon: '🖥️' },
  { id: 'coffee', name: 'Кофе-машина', actionCode: 'MAKE_COFFEE', x: 80, y: 70, icon: '☕' },
  { id: 'colleague', name: 'Коллега', actionCode: 'TALK_TO_COLLEAGUE', x: 25, y: 65, icon: '👔' },
  { id: 'window', name: 'Окно', actionCode: 'LOOK_OUTSIDE', x: 15, y: 80, icon: '🪟' },
];
...
export const OfficePage: React.FC = () => {
  ...
  const handleObjectClick = async (obj: OfficeObject) => {
  ...
  const gameTime = time || { day: 1, hour: 9 };
  ...
  return (
    <div className={styles.roomContainer}>
      ...
      <div className={styles.room}>
        <div className={styles.roomTitle}>🏢 Офис</div>
