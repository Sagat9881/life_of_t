 ...
 *   e.g. 0.65 = 65% of 480px = 312px tall.
 *   NOTE: most furniture specs have large canvases (256×192, 192×192)
 *   with pixel data concentrated in the lower portion. sceneHeight must
 *   account for the FULL canvas, not just the visible pixels.
