...
Asset Generator — модуль процедурной генерации графических ресурсов игры «Life of T».
...
Каждая текстура строится как тайл размером **N×N пикселей**, разбитый на **2×2 логические клетки**.
