...
- TBH (Task Board Health) — карточка + drilldown
- BC (Backend Completeness) — карточка + drilldown
- AC (Assets Coverage) — карточка + drilldown
- NC (Narrative Coverage) — карточка + drilldown
- CCH (CI/CD Health) — карточка + drilldown
