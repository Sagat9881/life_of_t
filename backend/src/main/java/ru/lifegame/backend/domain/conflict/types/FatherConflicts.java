...
public enum FatherConflicts implements ConflictType {
    FEELING_NEGLECTED("FEELING_NEGLECTED", "Чувствует себя забытым", "Отец обижен, что дочь его не навещает"),
    CRITICISM_OF_CHOICES("CRITICISM_OF_CHOICES", "Критика выбора", "Отец критикует жизненные решения"),
    CONCERN_FOR_WELLBEING("CONCERN_FOR_WELLBEING", "Беспокойство о благополучии", "Отец переживает за финансы и здоровье дочери");
